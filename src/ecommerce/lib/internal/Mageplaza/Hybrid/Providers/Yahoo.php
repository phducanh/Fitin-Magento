...
class Hybrid_Providers_Yahoo extends Hybrid_Provider_Model_OAuth2 {
    ...
    function getUserProfile() {
        ...
        $this->user->profile->identifier = isset($data->sub) ? $data->sub : "";
        $this->user->profile->firstName = isset($data->given_name) ? $data->given_name : "";
        $this->user->profile->lastName = isset($data->family_name) ? $data->family_name : "";
