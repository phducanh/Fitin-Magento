...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Currency implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderCss');
        return $pluginInfo ? $this->___callPlugins('renderCss', func_get_args(), $pluginInfo) : parent::renderCss();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setColumn');
        return $pluginInfo ? $this->___callPlugins('setColumn', func_get_args(), $pluginInfo) : parent::setColumn($column);
    }
    ...
    public function getColumn()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getColumn', func_get_args(), $pluginInfo) : parent::getColumn();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderExport');
        return $pluginInfo ? $this->___callPlugins('renderExport', func_get_args(), $pluginInfo) : parent::renderExport($row);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getInputValueElement');
        return $pluginInfo ? $this->___callPlugins('_getInputValueElement', func_get_args(), $pluginInfo) : parent::_getInputValueElement($row);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderHeader');
        return $pluginInfo ? $this->___callPlugins('renderHeader', func_get_args(), $pluginInfo) : parent::renderHeader();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderProperty');
        return $pluginInfo ? $this->___callPlugins('renderProperty', func_get_args(), $pluginInfo) : parent::renderProperty();
    }
