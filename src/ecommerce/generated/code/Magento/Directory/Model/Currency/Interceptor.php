...
class Interceptor extends \Magento\Directory\Model\Currency implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCurrencyCode()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCurrencyCode', func_get_args(), $pluginInfo) : parent::getCurrencyCode();
    }
    ...
    public function getRates()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getRates', func_get_args(), $pluginInfo) : parent::getRates();
    }
    ...
    public function setRates(array $rates)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setRates', func_get_args(), $pluginInfo) : parent::setRates($rates);
    }
    ...
    public function getRate($toCurrency)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getRate', func_get_args(), $pluginInfo) : parent::getRate($toCurrency);
    }
    ...
    public function getAnyRate($toCurrency)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAnyRate', func_get_args(), $pluginInfo) : parent::getAnyRate($toCurrency);
    }
    ...
    public function getFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getFilter', func_get_args(), $pluginInfo) : parent::getFilter();
    }
    ...
    public function format($price, $options = [], $includeContainer = true, $addBrackets = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('format', func_get_args(), $pluginInfo) : parent::format($price, $options, $includeContainer, $addBrackets);
    }
    ...
    public function formatPrecision($price, $precision, $options = [], $includeContainer = true, $addBrackets = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('formatPrecision', func_get_args(), $pluginInfo) : parent::formatPrecision($price, $precision, $options, $includeContainer, $addBrackets);
    }
    ...
    public function formatTxt($price, $options = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('formatTxt', func_get_args(), $pluginInfo) : parent::formatTxt($price, $options);
    }
    ...
    public function getOutputFormat()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOutputFormat', func_get_args(), $pluginInfo) : parent::getOutputFormat();
    }
    ...
    public function getConfigDefaultCurrencies()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfigDefaultCurrencies', func_get_args(), $pluginInfo) : parent::getConfigDefaultCurrencies();
    }
    ...
    public function getConfigBaseCurrencies()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfigBaseCurrencies', func_get_args(), $pluginInfo) : parent::getConfigBaseCurrencies();
    }
